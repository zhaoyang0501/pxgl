...
public class FeeController {
	...
	public Map<String, Object> list(
			...
			@RequestParam(value = "iDisplayLength", defaultValue = "10") int iDisplayLength, String feename
			) throws ParseException {
		int pageNumber = (int) (iDisplayStart / iDisplayLength) + 1;
		int pageSize = iDisplayLength;
		Page<Fee> fees = feeService.findAll(pageNumber, pageSize, feename);
	...
	@ResponseBody
	public Map<String, Object> save(Fee fee) {
		feeService.save(fee);
		Map<String, Object> map = new HashMap<String, Object>();
